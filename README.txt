TuftsEx - The textbook exhange network for Tufts students
...
TuftsEx tries to take the best of each of these options and combine them into one tool for students looking for books. Books are cheap because they are sold directly between users. Books are going to be available because there is finally one unified place where everyone can sell their books. And quality is virtually assured since a buyer can inspect the book before they make the purchase.

ABSTRACT IMPLEMENTATION

Users sign up for TuftsEx using their Tufts email address. They can create their own username, which is their ID in the site. Once they are a member, they can buy and sell textbooks in the marketplace. 

Putting up a book for sale - Users define the title of their book, the class it is used in (if there is one), and the quality of the book. (*Should we determine the price point?? At this point I'm leading towards no, they should let the market determine the price)
